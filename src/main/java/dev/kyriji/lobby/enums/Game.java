...
//			new Pos(-4.5, -1, 10.5, -150, 0)),
	BINGO(Component.text("Bingo").color(NamedTextColor.DARK_GREEN),
			List.of(Component.text("Compete with others to fill").color(NamedTextColor.GRAY),
					Component.text("your Bingo card first!").color(NamedTextColor.GRAY)),
			"matthewtest",
			Material.PAPER,
			new Pos(-4.5, -1, 10.5, -150, 0)),
	;
